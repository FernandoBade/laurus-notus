				...
				<div className="flex items-center content-center justify-center h-full">
                    ...
                    Sign up with
								...
								<div className="text-center btn-wrapper">
									<button
										className="inline-flex items-center px-4 py-2 mb-1 mr-2 text-xs font-normal uppercase transition-all duration-150 ease-linear bg-white rounded shadow outline-none active:bg-blueGray-50 text-blueGray-700 focus:outline-none hover:shadow-md"
										type="button"
									>
                    ...
                    Github
									...
									<button
										className="inline-flex items-center px-4 py-2 mb-1 mr-1 text-xs font-normal uppercase transition-all duration-150 ease-linear bg-white rounded shadow outline-none active:bg-blueGray-50 text-blueGray-700 focus:outline-none hover:shadow-md"
										type="button"
									>
